...
defined('ESHF_COMPATIBILITY_TMPL') or define('ESHF_COMPATIBILITY_TMPL', 'newsium');
...
function newsium_scripts()
{
    ...
    wp_enqueue_style('newsium-style', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ));
